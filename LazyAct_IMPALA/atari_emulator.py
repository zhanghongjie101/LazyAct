...
class AtariEmulator(BaseEnvironment):
    def __init__(self, actor_id, args):
        ...
        self.ale.setInt(b"random_seed", args.seed * (actor_id +1))
        ...
        self.random_seed = args.seed * (actor_id +1)
        self.reset_time = 0
    ...
    def __new_game(self):
        """ Restart game """
        self.reset_time += 1
        self.ale.setInt(b"random_seed", self.random_seed+self.reset_time)
        self.ale.reset_game()
        self.lives = self.ale.lives()
    ...
    def __process_frame_pool(self, frame_pool):
        ...
        img = np.array(Image.fromarray(img).resize((IMG_SIZE_X, IMG_SIZE_Y)))
